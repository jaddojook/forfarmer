...
class Detect2 : AppCompatActivity() {
    ...
    private val apiService = retrofit.create(ApiService2::class.java)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.detect2)
    ...
    private fun navigateToResultPage(resultImageBytes: ByteArray) {
        try {
            val resultIntent = Intent(this@Detect2, ResultActivity::class.java)
