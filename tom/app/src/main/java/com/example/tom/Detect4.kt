...
class Detect4 : AppCompatActivity() {
    ...
    private val apiService = retrofit.create(ApiService4::class.java)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.detect4)
    ...
    private fun navigateToResultPage(resultImageBytes: ByteArray) {
        try {
            val resultIntent = Intent(this@Detect4, ResultActivity::class.java)
