...
class Detect3 : AppCompatActivity() {
    ...
    private val apiService = retrofit.create(ApiService3::class.java)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.detect3)
    ...
    private fun navigateToResultPage(resultImageBytes: ByteArray) {
        try {
            val resultIntent = Intent(this@Detect3, ResultActivity::class.java)
